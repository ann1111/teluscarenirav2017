...
<?php
$nlettr_res = $this->db->query("SELECT user_name from wl_customers WHERE user_name ='".$catresult->subscriber_email."'")->row();
?>
    ...
    <div class="content">
      <?php error_message();validation_message(); ?>
        ...
        <table class="form"> 
            ...
            <td><input type="text" name="subscriber_email" size="40" value="<?php echo set_value('subscriber_email',$catresult->subscriber_email);?>" <?php echo is_object($nlettr_res) ? 'readonly="readonly"' : '';?>></td>
          </tr>  
          <tr>         
          <tr>
            <td align="left">&nbsp;</td>
