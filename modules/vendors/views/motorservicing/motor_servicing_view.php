...
<p class="fr mt1"><a href="<?php echo base_url(); ?>vendors/motorservicing/edit_vendor_entries" class="btn1 radius-20t" title="�Go Back">Edit Vendor Entries</a> </p>
 ...
 <div class="cb mb15"></div>	
<style>
.multiselect {padding: 5px;width: 70%;height:100px;border-radius: 5px;border: 1px solid #999;font-size: 14px;cursor: pointer;}.multiselect-on {    color:#ffffff;    background-color:#000099;}
</style>
