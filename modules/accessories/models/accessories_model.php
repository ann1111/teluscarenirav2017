...
class Accessories_model extends MY_Model
{
	...
	public function getaccessories($opts=array())
	{
		...
		$result = $this->findAll('wl_accessories as a',$fetch_config);
		return $result;
	}
	...
	public function get_accessories_by_id($id)
	{
		$id = applyFilter('NUMERIC_GT_ZERO',$id);
		
		if($id>0)
		{
			$condtion = "status !='2' AND acc_id=$id";
			$fetch_config = array(
									'condition'=>$condtion,							 						'debug'=>FALSE,
									'return_type'=>"array"							  
								  );
			$result = $this->find('wl_accessories',$fetch_config);
			return $result;
		}
	}
}
