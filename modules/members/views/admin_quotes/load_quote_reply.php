...
if(is_array($res) && !empty($res))
{
  ...
  foreach($res as $key=>$val)
  {
	...
	<div class="mybox2 trans_eff <?php echo $exclass;?> xitemContainer">
	  <p class="robotoC fs18 p10 hand conv_ttl <?php if($this->userId!=$val['posted_by']){echo 'orange';}?>"><img src="<?php echo theme_url();?>images/<?php echo $this->userId==$val['posted_by'] ? 'art1.png' : 'art2.png';?>" class="vab mr2" alt="">  <?php echo date("d F, Y H:i A",strtotime($val['date_added']));?></p>
	  <div class="mt10 p10">
