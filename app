...
$db['local']['username'] = 'teluscar_dev';
$db['local']['password'] = 'Alldone?123';
$db['local']['database'] = 'teluscar_telusnew';
...
$db['testing']['username'] = 'teluscar_dev';
$db['testing']['password'] = 'Alldone?123';
$db['testing']['database'] = 'teluscar_assurance_telus';
...
$db['live']['username'] = 'dineshs_tl';
$db['live']['password'] = 'D_k@fyt8$';
$db['live']['database'] = 'jsholiday';
