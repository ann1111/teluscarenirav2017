	...
	{	
	 ...
	 public  function index()
	 {
		...
		{			
	        ...
	        $this->form_validation->set_rules('faq_question','Question',"trim|required|xss_clean|max_length[225]|unique[wl_faq.faq_question='".$this->db->escape_str($this->input->post('faq_question'))."' AND status!='3']");
	   ...
	   public function edit()
	   {
		   ...
		   { 
		        $this->form_validation->set_rules('faq_question','Question',"trim|required|xss_clean|max_length[225]|unique[wl_faq.faq_question='".$this->db->escape_str($this->input->post('faq_question'))."' AND status!='3' AND faq_id!='".$res['faq_id']."']");
			    $this->form_validation->set_rules('faq_answer','Answer','trim|required|required_stripped|xss_clean|max_length[8500]');
