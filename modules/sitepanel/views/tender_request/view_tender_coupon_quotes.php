 ...
 <div class="box">
    ...
    <div class="heading">
     ...
     <div class="content">
		...
		<?php echo form_open("sitepanel/admin_tenders/tender_coupons",'id="search_form" method="get" '); ?>
		...
		<table width="100%"  border="0" cellspacing="3" cellpadding="3" >
          ...
          <tr>
			<td align="center" >Search [title ] 
				...
				{ 
				  echo anchor("sitepanel/admin_tenders/tender_coupons",'<span>Clear Search</span>');
				} 
				?>
            </td>
		</tr>        
