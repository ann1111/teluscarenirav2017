 ...
 <div class="box">
    ...
    <div class="heading">
     ...
     <div class="content">
       ...
       <?php echo form_open_multipart('sitepanel/contact_address/add/');?>  
	...
	<table width="90%"  class="tableList" align="center">
		...
		<tr class="trOdd">
			...
			<td>
			<?php echo CountrySelectBox(array('name'=>'country_name','format'=>'style="padding:5px;"','current_selected_val'=>set_value('country_name') )); ?>
			</td>
		</tr>
		<tr class="trEven">
			<td width="253" height="26">* Address:</td>
			<td width="597" style="f">
            <textarea name="address" rows="10" cols="42"><?php echo set_value('address');?></textarea>
