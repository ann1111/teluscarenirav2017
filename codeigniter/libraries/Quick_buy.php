...
class CI_Quick_buy {
	...
	public function __construct($params = array())
	{
		...
		if ($this->CI->session->userdata('quick_buy_contents') !== FALSE)
		{
			$this->_cart_contents = $this->CI->session->userdata('quick_buy_contents');
		}
		else
		{
	...
	function _save_cart()
	{
		...
		{
			$this->CI->session->userdata('quick_buy_contents');
		...
		$this->CI->session->set_userdata(array('quick_buy_contents' => $this->_cart_contents));
	...
	function destroy()
	{
		...
		$this->CI->session->unset_userdata('quick_buy_contents');
	}
