<?php $this->load->view('includes/header'); ?>  
 ...
 <div class="box">
    ...
    <div class="heading">
      ...
      <div class="buttons"> <?php echo anchor("sitepanel/company_type/add/",'<span>Add Company Type</span>','class="button" ' );?></div>
     ...
     <?php 
	 echo form_open("sitepanel/company_type/",'id="search_form" method="get"');?>
	   ...
	   <table width="100%"  border="0" cellspacing="3" cellpadding="3" >
                ...
                <tr>
					...
					<?php	
					 ...
					 { 
					    echo anchor("sitepanel/company_type/",'<span>View All</span>');
					 }
					 ?>
	 ...
	 <?php 
		 ...
		 {
		  echo form_open("sitepanel/company_type/",'id="data_form" ');
        ...
        <tbody>
          ...
          <tr>
			...
			{
			?>
			  <?php echo anchor("sitepanel/company_type/edit/$pageVal[fld_id]/".query_string(),'Edit'); ?>
			<?php
			}
			?>
			</td>
