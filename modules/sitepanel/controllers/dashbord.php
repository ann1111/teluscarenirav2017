...
class Dashbord extends Admin_Controller {
  ...
  public function __construct() {
    ...
    public  function index()
	{
		...
		$data['total_contact_request']  = $this->count_record(' wl_enquiry',"type ='3' AND status !='2' AND reply_status = 'N'");

		//$data['total_order']  = 0;//$this->count_record(' wl_order',"order_status !='deleted' ");

		$data['total_member'] = $this->count_record('wl_customers',"status !='2' AND user_type ='1' ");

		$data['total_vendors'] = $this->count_record('wl_customers',"status !='2' AND user_type ='2' ");
