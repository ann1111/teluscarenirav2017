      ...
      <?php 
	       ...
	       echo form_open("sitepanel/shipping/",'id="search_form" method="get" ');?>
			...
			<table width="100%"  border="0" cellspacing="3" cellpadding="3" >
				<tr>
					<td align="center" >Search [ State ] <input type="text" name="keyword" value="<?php echo $this->input->get_post('keyword');?>"  />&nbsp;
	  ...
	  <table class="list" width="100%" id="my_data">
        ...
        <thead>
          <tr>
            ...
            <td width="405" class="left">State</td>
          ...
          <tr>
            ...
            <td class="left"><?php echo $pageVal['shipping_type'];?></td>
			 ...
			 <?php //echo display_price($pageVal['shipment_rate']); 
			  echo display_price($pageVal['shipment_rate']); ?> </td>      
