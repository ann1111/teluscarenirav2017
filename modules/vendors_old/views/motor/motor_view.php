...
<p class="fr mt1"><a href="<?php echo base_url(); ?>vendors/motor/vendor_entries" class="btn1 radius-20t" title="�Go Back">Check Vendor Entries</a> </p>
	...
	<h2 class="bb1 pb5"> Add - Motor Insurance - Plans - Rates - Services </h2>
	...
	<table class="tg">
		...
		<h4> Exclusion - Add List for Exclusion</h4>
	<div class="cb mb15"></div>
	...
	<?php //echo '<pre>'; print_r($vehicle); exit;   ?>
	 ...
	 <?php if($_SESSION['motor_exclude_data'] != ''){ ?>
	  ...
	  <table>	
		  <tr class="tg"> 	
			  <td class="tg-031e"> Vehicle Type </td> 	
			  <td class="tg-031e"> Vehicle Name </td>	
			  <td class="tg-031e"> Vehicle Models </td>	
			  <td class="tg-031e"> Vehicle Year </td> 
			  <td class="tg-031e"> Driver Age </td> 
			  <td class="tg-031e"> Driving Licence</td>	
			  <td class="tg-031e"> Emirate </td>	
			  <td class="tg-031e"> GCC SPEC </td>		
			  <td class="tg-031e"> Vehicle Register </td>	
		  </tr>		
		  <tr> 		
			  <td class="tg-031e" id="Vehicle_type_field"> 
			  <?php echo get_vehicle_type($_SESSION['motor_exclude_data']['vehicletype']); ?> </td>	
			  <td class="tg-031e" id="vehicle_name_field"> <?php echo $_SESSION['motor_exclude_data']['vehicle_name']; ?> </td>	
			  <td class="tg-031e" id="vehicle_models_field"> <?php foreach($_SESSION['motor_exclude_data']['vehicle_models'] as $modal){ echo $modal; echo '<br>'; }  ?>
			  </td>		
			  <td class="tg-031e" id="vehicle_year_field"> <?php echo $_SESSION['motor_exclude_data']['vehicle_year']; ?> </td> 	
			  <td class="tg-031e" id="driver_age_field"> <?php echo get_driver_age($_SESSION['motor_exclude_data']['driver_age']); ?> </td> 
			  <td class="tg-031e" id="drving_field"> <?php echo get_driver_licence($_SESSION['motor_exclude_data']['Driving_Licence']); ?> </td>
			  <td class="tg-031e" id="country_id_field"> <?php echo $_SESSION['motor_exclude_data']['emirates']; ?> </td> 
			  <td class="tg-031e" id="gcc_status_field"> <?php echo get_gcc($_SESSION['motor_exclude_data']['gcc_status']); ?> </td> 
			  <td class="tg-031e" id="vehicle_register_field"> 
			  <?php foreach($_SESSION['motor_exclude_data']['vehicle_register'] as $vr){ echo get_vehicle_reg_for($vr); echo '<br>'; } ?> 
			  </td>		
		  </tr>	
	  </table>
	 <?php } ?>
...
<div class="w90 auto mt30">
	...
	<div class="fl w25 short_form ml16">	
		...
		<select class="form-control" name="vehicletype" id="Vehicle_type" tabindex="-98">	
			...
			<?php echo $vt['vehicle_type']; ?></option>	
			<?php } ?>						        
		</select>		
		</p>
	</div>
	...
	<div class="cb mb15"></div>
	  ...
	  <!--<div class="fl w32 short_form ml16">
		...
		<div class="cb mb15"></div>		
		<h3 class="greenHeader"><label for="rd3_4" class="checkboxLabel">COMPREHENSIVE</label></h3>	
		<div class="cb mb15"></div>		
				<div class="fl w15 short_form ml16">				
					<div class="fldContainer">
					<label class="frmLabel">AGENCY TYPE</label><br>		
					Agency <br><br>			
					NON-AGENCY(Standard) <br><br>	
					NON-AGENCY(Superior) <br><br>					
				...
				<div class="w100" >	
					...
					<div class="fl w19 short_form ml16">
						<div class="fldContainer">
							  <label class="frmLabel" >MIN VALUE</label><br>		
							  <input type="text" class="form-control" name="agency_type[1][minvalue]" id="current">	<br>					  
							  <input type="text" class="form-control" name="agency_type[2][minvalue]" id="current">	<br>
							  <input type="text" class="form-control" name="agency_type[3][minvalue]" id="current"><br>
						 </div>
					</div>
					
					<div class="fl w19 short_form ml16">
						<div class="fldContainer">
							  <label class="frmLabel" id="vLabel">PREMIUM VALUE IN (%)</label>	<br>				
							  <input type="text" class="form-control" name="agency_type[1][premium_value]" id="current"><br>
							  <input type="text" class="form-control" name="agency_type[2][premium_value]" id="current">	<br>	            
							  <input type="text" class="form-control" name="agency_type[3][premium_value]" id="current"><br>
						</div>
					</div>
				</div>
				<div class="" >	
					...
					<div class="fl w19 short_form ml16">
						<div class="fldContainer">
							  <label class="frmLabel" >MIN VALUE</label><br>		
							  <input type="text" class="form-control" name="agency_type[1][comm_minvalue]" id="current">	<br>					  
							  <input type="text" class="form-control" name="agency_type[2][comm_minvalue]" id="current">	<br>
							  <input type="text" class="form-control" name="agency_type[3][comm_minvalue]" id="current"><br>
						 </div>
					</div>
					...
					<div class="fl w19 short_form ml16">
						<div class="fldContainer">
							  <label class="frmLabel" id="vLabel">PREMIUM VALUE IN (%)</label>	<br>				
							  <input type="text" class="form-control" name="agency_type[1][comm_premium_value]" id="current"><br>
							  <input type="text" class="form-control" name="agency_type[2][comm_premium_value]" id="current">	<br>	            
							  <input type="text" class="form-control" name="agency_type[3][comm_premium_value]" id="current"><br>
						</div>
					</div>
				</div>
        </div>
				...
				<div class="companContainer">
					<div class="cb mb15"></div>												<h3 class="greenHeader"><label for="rd3_414" class="checkboxLabel"> THIRD PARTY LIABILITY </label></h3>					<div class="cb mb15"></div>	
	...
	<div class="w90 auto mt30">
	 ...
	 <div class="w90 auto mt30">	
		 <h3> Do You Do Any Exceptional Cases:-  </h3>		
		 <div class="cb mb15"></div>	
		 <div class="fl w22 short_form ml16">	
