...
<?php
$vendor_register_content = get_db_field_value('wl_cms_pages','page_description',"WHERE friendly_url='vendor-register-content' AND status='1'");
...
<div class="breadcrumb">
  <div class="wrapper"> You are here :
	...
	<b>&gt;</b>
	<div itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><span itemprop="title"><strong>SBP (Service Business Provider) Registration</strong></span></div>
  </div>
</div>
...
<div class="wrapper pt20 pb20" style="min-height:300px">
  <div class="bg-blue1 p25 radius-3 white">
	...
	<h1 class="fs24 white">SBP <b class="weight400 white">(Service Business Provider)</b> Registration</h1>
  </div>
  <?php echo form_open('users/vendor_register'); ?> 
  <div class="fl w65 mt20 short_form fs14 bg-gray1 p20 border1 radius-5">
	...
	<legend class="b fs18 b mb10 blue"> Other Information :</legend>
	<div>
	  <p class="w36 pt8 b "><label>Your Identity <b class="red">*</b> :</label></p>
	  <p class="w62 mt3 b blue"> <span class="fls">
	...
	<div class="input_l">
	  <p class="pt8"><label for="contact_name">Company Name <b class="red">*</b> :</label></p>
	  <div class="mt3">
		<input name="company_name" id="company_name" type="text" value="<?php echo set_value('company_name'); ?>" style="width:90%; padding:5px;">
	...
	<div class="input_l">
	  ...
	  <div class="mt3">
		<input name="first_name" id="contact_name" type="text" value="<?php echo set_value('first_name'); ?>" style="width:90%; padding:5px;">
	...
	<div class="input_r">    
	  <p class="pt8"><label for="nature_business">Nature of business <b class="red">*</b> :</label></p>
	  <div class="mt3">
		<select name="cat_id" id="nature_business" style="width:90%; padding:5px;">
		  ...
		  if($root_cat_qry->num_rows() > 0)
		  {
			...
			{
			?>
			  <option value="<?php echo $val['category_id'];?>"<?php echo set_value('cat_id')==$val['category_id'] ? ' selected="selected"' : '';?>><?php echo $val['category_name'];?></option>
			<?php
			}
		  }
		  ?>
	...
	<fieldset class="pb15 mt10" style="border:0; border-bottom:1px solid #f1f1f1">
	<p class="w36 pt8"><label for="verification_code">Word Verification <b class="red">*</b> :</label></p>
	<div class="w62">
	...
	<label><input type="checkbox" name="terms" value="Y" class="fl mb15 mr10"<?php echo set_value('terms')=='Y' ? ' checked="checked"' : '';?>>
...
<a href="<?php echo base_url();?>terms-and-conditions" class="uu" target="_blank" title="Terms &amp; Conditions">Terms &amp; Conditions</a> of <b>TelUs Care.</b></label>
  ...
  <div class="fr w32 mt65">
	<div><?php echo $vendor_register_content;?></div>
  </div>
  <div class="cb"></div>
