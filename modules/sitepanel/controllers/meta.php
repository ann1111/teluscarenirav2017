	...
	public function __construct()
	{
	 ...
	 public  function index($page = NULL)
	 {
		...
		public function add()
		{
			...
			$this->form_validation->set_rules('meta_title','Title','trim|required|xss_clean|max_length[100]');
	   ...
	   public function edit()
	   {
		 ...
		 { 
			...
			//$this->form_validation->set_rules('page_url','URL',"trim|required|unique[wl_meta_tags.page_url='".$this->db->escape_str($this->input->post('page_url'))."' AND meta_id!='".$res['meta_id']."']");
