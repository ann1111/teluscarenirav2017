...
class Banners extends Admin_Controller
{
	...
	{		  
		...
		$data['ckeditor']  =  set_ck_config(array('textarea_id'=>'text_banner','type'=>'specific'));	
		 ...
		 $this->form_validation->set_rules('banner_alt','Banner Alt',"trim|max_length[200]");
		 $this->form_validation->set_rules('banner_url','Banner URL',"trim|max_length[170]");
		 $this->form_validation->set_rules('banner_text','Banner Text',"trim|max_length[2000]");
		...
		if($this->form_validation->run()==TRUE)
		{
				...
				$banner_alt = $this->input->post('banner_alt')!='' ? $this->input->post('banner_alt') : null;
			
				$posted_data = array(
				'banner_position'=>$this->input->post('banner_position'),
				'banner_page'=>$this->input->post('section'),
				'banner_url'=>$this->input->post('banner_url')!='' ? $this->input->post('banner_url') : null,
				'banner_text'=>$this->input->post('banner_text')!='' ? $this->input->post('banner_text') : null,
