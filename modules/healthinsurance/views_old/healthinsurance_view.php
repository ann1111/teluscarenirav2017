...
<div class="wrapper pt20 pb20 " style="min-height:300px">
  ...
  <div class="fl w100 mt20 bhdw fs14 p20 border1 radius-5" style="background:#f5ffff;">
	...
	<fieldset class="pb15 mt10" style="border:0; border-bottom:1px solid #f1f1f1">
		...
		<div class="input_ll">
			<div class="mt3">
			<label> Employee  <input type="radio" name="emptype" id="emptype" value="Emp"/></label>
			<label> Dependent <input type="radio" name="emptype" id="emptype1" value="Dep"/></label>
		  <div class="cb pb5"></div>
		</div>
		</div>
...
.divTableBody {
  ...
  $('document').ready(function() {
	...
	$('#submit').click(function(){
		...
		if($('#emptype').prop("checked") == false && $('#emptype1').prop("checked") == false){
