...
.tg th{font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:#ccc;color:#333;background-color:#999;font-weight:700;}
.tg .tg-s6z2{text-align:center}
.tg .tg-spn1{background-color:#f9f9f9;text-align:center}
.tg .tg-4eph{background-color:#f9f9f9}
.success{  font-size: 20px;  margin: 0 0 0 500px; color:green;}
.tg .submit_but{background-color:#2BBBAD;color:#fff;padding:3px 10px;border-radius:4px;}
...
<h2 class="bb1 pb5 black text-center"> Edit & Update - Rates - Pest Control Service </h2>
		<table class="tg w100 mt40 mb40">
			...
			<tr class="text-center">
				...
				<input class="submit_but" type="submit" name="submit" value="EDIT" name="submit" />
	...
	<div class="mt20 w80 short_form fs14 auto p20 border1">
	  ...
	  <fieldset class="pb15 mt30" style="border:0;">
		...
		<p class="w36 pt8">
		  ...
		  <label for="upload_doc">TYPE OF PREMISES : <b class="red">*</b></label>
		...
		<p class="w36 pt8">
		  ...
		  <label for="type_service">KIND OF PREMISES : <b class="red">*</b></label>
		</p>
