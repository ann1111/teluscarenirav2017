 ...
 <div class="box">
    ...
    <div class="heading">
     ...
     <div class="content">  
        ...
        <input type="text" name="keyword" placeholder="Keywords" value="<?php echo $this->input->get_post('keyword');?>" style="width:340px;"   />
                 ...
                 <input name="from_date" type="text" id="textfield3" class="start_date1 input-bdr2 radius-5" placeholder="From Date" style="width:165px;">&nbsp; 
                   ...
                   <td>&nbsp;
                     <a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a>
                         ...
                         &nbsp; Keywords Like : Invoice Number , name , email, payment status, order status 
		<?php 
		...
		?>
			<div class="b fs12 pb10">Total Transaction: <?php echo display_price($total_transaction);?></div>
			<div class="cb"></div>
			...
			{ 
				...
				<tr>
					...
					<br /><br /><?php echo anchor_popup('sitepanel/orders/send_mail/'.$pageVal['order_id'], 'Send Mail', $atts);?><br />
					</td>
					<td align="left"><?php echo $pageVal['payment_status'];?>
					...
					<td class="left"><?php  echo $pageVal['order_status']; ?></td>
				</tr>
			<?php
			}		   
			?> 
