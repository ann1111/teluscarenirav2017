           ...
           <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page();?> </div>
			...
			<thead>
			  <tr>
				...
				<td width="265" class="left">Poster </td>
				<!--td width="278" class="left">Title</td-->
				<td width="351" class="left">Description</td>
				<td width="219" class="right">Status</td>
				<td width="219" class="right">Action</td>
			  </tr>
			</thead>
			<tbody>
			<?php 	
			...
			?> 
				<tr>
					...
					<td class="left" valign="top">
						<img src="<?php echo get_image('testimonial',$pageVal['photo'],50,50,'AR');?>" align="top" />&nbsp;<?php echo $pageVal['poster_name'];?>
                        <?php if($pageVal['email']!='' && $pageVal['email']!='0')
						{
					...
					<td><?php echo char_limiter($pageVal['testimonial_description'],100);?></td>
