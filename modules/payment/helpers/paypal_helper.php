...
function paypalForm($order_res)
{
	...
	$amount = formatNumberWithRounding($amount,2);
...
<body style="margin:0px;">    
    <div style="text-align:left; font-size: 22px; font-weight:bold;  background-color:#f9f9f9; border:#efefef; padding:20px;">
		...
		<input type="hidden" name="business" value="info@e-storesdirect.co.uk"> 
		...
		<input type="hidden" name="cancel_return" value="<?php echo base_url(); ?>payment/order_success/paypal/<?php echo md5($orderid);?>"/>
