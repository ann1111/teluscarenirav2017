      ...
      <div style="float: right; width: 24%;">
        ...
        <div style="background:#f8f8f8; border: 1px solid #d9d9d9; padding: 10px; height: 49%;">
          ...
          <table width="100%" border="0" cellspacing="5" cellpadding="0">
              ...
              <tr>
                <td>Total Vendors : <?php echo  $total_vendors; ?></td>
                <td><a href="<?php echo base_url();?>sitepanel/vendors/">View </a></td>
              </tr>
              <tr>
			  ...
			  <tr>
                <td>Enquiry/Feedback : <?php echo $total_contact_request; ?></td>
                <td><a href="<?php echo base_url();?>sitepanel/enquiry?reply_status=N">View </a></td>
              </tr>    
          ...
          <br /> 
           <br />
            <a href="<?php //echo base_url();?>sitepanel/orders/"></a><br /><br />
            <br /><br />
            <br /><br />
          </div>
        </div>
