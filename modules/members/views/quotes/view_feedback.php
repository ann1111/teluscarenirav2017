...
<div class="wrapper pt20 pb20" style="min-height:300px;">
  ...
  <div class="w90 auto mt30">
	<h2 class="bb1 pb5">Manage Feedbacks</h2>
	<div class="bb mt10 border1">
	  <?php error_message();?>
	  <div class="cb"></div>
	  <div class="tab_links">
		<a href="<?php echo base_url();?>members/quotes/view_feedback?type=complain" class="xtabs <?php echo $feed_type=='complain' || $feed_type=='' ? ' act' : '';?>">Complain</a>
		<a href="<?php echo base_url();?>members/quotes/view_feedback?type=suggestion" class="xtabs<?php echo $feed_type=='suggestion' ? ' act' : '';?>">Suggestions</a>
		<a href="<?php echo base_url();?>members/quotes/view_feedback?type=queries" class="xtabs<?php echo $feed_type=='queries' ? ' act' : '';?>">Queries</a>
	  </div>
	  ...
	  <div class="form_box">
		...
		if(is_array($res) && !empty($res))
		{
		  ...
		  <?php $this->load->view('members/quotes/load_feedback',$data);?>
			</table>
		  </div>
