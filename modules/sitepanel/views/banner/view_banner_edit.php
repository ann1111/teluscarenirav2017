...
<tr class="trOdd">
	...
	<td align="left">
		<input type="text" name="banner_alt" value="<?php echo set_value('banner_alt',$res->banner_alt);?>" />
		<br />
	</td>
</tr>
<tr class="trOdd">
...
<tr class="trOdd" id="banner_cont_text" style="<?php echo set_value('banner_position',$res->banner_position)=='Home Top' ? '' : 'display:none;';?>">
	<td width="28%" height="26" align="right" >Banner Text</td>
	<td align="left">
		<textarea name="banner_text" rows="5" cols="50" id="text_banner" ><?php echo set_value('banner_text',$res->banner_text);?></textarea>
