...
function front_pagination($base_uri, $total_rows, $record_per = NULL, $uri_segment,$refresh=FALSE,$data_form="#myform")
{		
	$ci = CI();
...
if ( ! function_exists('pagination_refresh'))
{
	...
	{
			$ci = CI();			
	        $config['full_tag_open']        = '<p class="paging fr">';  
			...
			$config['cur_tag_open']	= '<a href="#" class="select">';
...
?>
     <select  name="<?php echo $name;?>" id="<?php echo $per_page_id;?>"  class="p2">
