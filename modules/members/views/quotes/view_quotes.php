...
<?php
$product_res = $this->db->select('prod_title,products_id')->get_where('wl_products',array('user_status'=>'1','status !='=>'2'))->result_array();
?>
...
<div class="wrapper pt20 pb20" style="min-height:300px;">
  ...
  <div class="w90 auto mt30">
	<?php error_message();?>
	<h2 class="bb1 pb5">Manage Quote</h2>
	<div class="bg-gray1 border2 p10 pl15">
	  <?php echo form_open('');?>
	  <p class="b mt7 fl">Sort by : </p>
	  <select name="product_id" class="fl w49 b fs14 p6 radius-3 ml10">
	...
	<div class="bb mt10">
	  ...
	  if(is_array($res) && !empty($res))
	  {
		...
		<div id="xlistContainer">
		  <?php $this->load->view('members/quotes/load_quotes',$data);?>
		</div>
