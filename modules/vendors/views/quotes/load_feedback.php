...
if(is_array($res) && !empty($res))
{
  ...
  foreach($res as $key=>$val)
  {
	...
	$dtl_link = base_url().'vendors/quotes/quote_details/'.$val['ref_quot_id'];
	?>
	  ...
	  <tr class="w100 tab-bdr2 fs13 xitemContainer">
		...
		//{
		?>
		  <a href="<?php echo base_url();?>vendors/quotes/remove_feedback/<?php echo $val['feedback_id'];?>" onclick="return confirm('Are you sure you want to remove this record');" title="Delete Record"><img src="<?php echo theme_url();?>images/m-no.png"  alt=""></a>
		<?php
		//}
		?>
		</td>
